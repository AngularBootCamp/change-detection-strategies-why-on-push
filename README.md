# Angular Boot Camp example: change-detection-strategies-why-on-push
...
**[StackBlitz for change-detection-strategies-why-on-push](https://stackblitz.io/github/AngularBootCamp/change-detection-strategies-why-on-push)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/change-detection-strategies-why-on-push.git
cd change-detection-strategies-why-on-push
npm install
npm start
```
